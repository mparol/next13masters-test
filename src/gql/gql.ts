...
const documents = {
    ...
    "query ProductsGetAllRatings {\n  products {\n    id\n    reviews {\n      rating\n    }\n  }\n}": types.ProductsGetAllRatingsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ProductGetReviewsCount($prodId: ID!) {\n  reviewsConnection(where: {product: {id: $prodId}}) {\n    aggregate {\n      count\n    }\n  }\n}"): typeof import('./graphql').ProductGetReviewsCountDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation ProductUpdateRating($prodId: ID!, $rating: Float!) {\n  updateProduct(where: {id: $prodId}, data: {avgRating: $rating}) {\n    id\n  }\n}"): typeof import('./graphql').ProductUpdateRatingDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query ProductsGetAllRatings {\n  products {\n    id\n    reviews {\n      rating\n    }\n  }\n}"): typeof import('./graphql').ProductsGetAllRatingsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
